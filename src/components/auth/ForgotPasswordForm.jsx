...
export default function ForgotPasswordForm({ onBackToLogin, onClose }) {
        ...
        <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md p-8 relative">
          ...
          <div className="text-center">
            ...
            <button
              ...
              className="w-full bg-deep-blue text-white py-3 px-4 rounded-lg font-semibold hover:bg-sky-blue transition-colors"
            >
              Back to Login
            </button>
          </div>
